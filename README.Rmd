...
subtitle: "Oferta de formación continua organizado por la Escuela de Ciencias Geográficas (UASD) <br> Portal del curso"
...
github_md_url <- paste0('https://github.com/geofis/curso-linux-gee-aplicaciones-r-python-julio-2025/blob/main/')
```
...
[https://github.com/geofis/curso-linux-gee-aplicaciones-r-python-julio-2025.git](https://github.com/geofis/curso-linux-gee-aplicaciones-r-python-julio-2025.git)

***

## Dirigido a ...

- Estudiantes y profesionales interesados en aprender sobre GNU/Linux, Python, R y Google Earth Engine para análisis espacial.
...
- [Motivación](`r paste0(github_pages_url_general, 'media/motivacion.html')`s
...
- [**Tema 1. Linux o GNU/Linux: kernel, filosofía, distros, terminal, estructura**](`r paste0(github_pages_url_general, 'media/tema-1-intro.html')`).
...
- [**Tema 2. Comandos esenciales, tuberías, permisos**](`r paste0(github_pages_url_general, 'media/tema-2-intro.html')`)
...
- [**Tema 3. Introducción a Python para análisis espacial**](`r paste0(github_pages_url_general, 'media/tema-3-intro.html')`)
...
- [**Tema 4. Introducción a R para análisis espacial**](`r paste0(github_pages_url_general, 'media/tema-4-intro.html')`)
...
- [**Tema 5. Introducción a Google Earth Engine (GEE)**](`r paste0(github_pages_url_general, 'media/tema-5-intro.html')`)
...
- [**Tema 6. Aplicaciones integradas: de lo local a lo global**](`r paste0(github_pages_url_general, 'media/tema-6-intro.html')`)
...
- [**Tema 1. Instala y prueba una o varias distros Linux, terminal, estructura**](`r paste0(github_pages_url_general, 'media/tema-1-practica.html')`)
...
- [**Tema 2. Aprende a navegar y operar de forma avanzada en la terminal**](`r paste0(github_pages_url_general, 'media/tema-2-practica.html')`)
...
- [**Tema 3. Manipula datos espaciales vectoriales y ráster con Python**](`r paste0(github_pages_url_general, 'media/tema-3-practica.html')`)
...
- [**Tema 4. Realiza análisis espacial básico en R**](`r paste0(github_pages_url_general, 'media/tema-4-practica.html')`)
...
- [**Tema 5. Usa Earth Engine para analizar imágenes satelitales**](`r paste0(github_pages_url_general, 'media/tema-5-practica.html')`)
...
- [**Tema 6. Integra GEE con R o Python para análisis reproducible**](`r paste0(github_pages_url_general, 'media/tema-6-practica.html')`)
